...
### Embedded collection grid

Add a [Twitter collection](https://dev.twitter.com/web/embedded-timelines/collection) with a grid template display to an article by URL or by using the `twitter_grid` shortcode macro.
